...
<body>
	...
	<div id="home">
		...
		<header>
			...
			<div id="sign_in_btns">
				<a href="?p=sign-up" class="no-text-style"><span class="btn normal-btn">Sign In</span></a>
				<a href="?p=sign-up" class="no-text-style"><span class="btn">Sign Up</span></a>
			</div>
		</header>
		<!-- End of: header  -->
		...
		<nav>
			...
			<div id="nav_div">
				...
				<ul id="navlist">
					...
					<li class="<?php if($title == 'Item Detail') echo 'active';  ?>"><a href="?p=item-detail">Products</a></li>
					<li class="<?php if($title == 'Contact Us') echo 'active';  ?>"><a href="?p=contact-us">Contact</a></li>
				</ul>
			</div>
		</nav>
		<!-- End of: nav  -->