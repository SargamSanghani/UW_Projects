...
<main class="home">
    ...
    <div id="wrapper">
        ...
        <p id="slider" class="grey">
            ...
            <!-- search bar for only desktop  -->
            <form action="/" class="desktop-search">
                <input type="hidden" name="p" value="menu">
                <input type="text" name="search" placeholder="Search" class="home-search">
                <input class="home-search-btn btn" type="submit" value="Search" style="height: 45px"/>
            </form>

        </p>

        <h1 class="fancy-header"><span>We Provide</span></h1>
        ...
        <h1 class="fancy-header"><span>Local Favourites</span></h1>

        <!-- Start of: card list for food items  -->
        <div class="card_list">

            <div class="item-card cursor-pointer" style="margin-left: 0;">
                <a href="?p=detail"><img src="images/item-1.jpg" width="287" height="191"
                        alt="Food-1" /></a>
                <p class="price">10.99 $</p>
            </div>

            <div class="item-card cursor-pointer">
                <a href="?p=detail"><img src="images/item-2.jpg" width="287" height="191"
                        alt="Food-2" /></a>
                <p class="price">10.99 $</p>
            </div>

            <div class="item-card cursor-pointer" style="margin-right: 0;">
                <a href="?p=detail"><img src="images/item-3.jpg" width="287" height="191"
                        alt="Food-3" /></a>
                <p class="price">10.99 $</p>
            </div>
