		...
		<div id="wrapper">
			...
			<div class="card_list">
				...
				<div class="item-card cursor-pointer" style="margin-left: 0;">
					<a href="item-detail.html"><img src="images/item-1.jpg" width="287" height="191"
							alt="Food-1" /></a>
					<p class="price">10.99 $</p>
				</div>

				<div class="item-card cursor-pointer">
					<a href="item-detail.html"><img src="images/item-2.jpg" width="287" height="191"
							alt="Food-2" /></a>
					<p class="price">10.99 $</p>
				</div>

				<div class="item-card cursor-pointer" style="margin-right: 0;">
					<a href="item-detail.html"><img src="images/item-3.jpg" width="287" height="191"
							alt="Food-3" /></a>
					<p class="price">10.99 $</p>
				</div>
