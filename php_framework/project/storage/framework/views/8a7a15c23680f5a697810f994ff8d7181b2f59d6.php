...
<div class="row m-0">
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card m-3">
                    <img class="card-img-top list-img" src="/storage/<?php echo e($creature->image); ?>" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo e($creature->name); ?></h5>
                        <div class="card-text ellipsis-3">
                            <?php echo $creature->description; ?>
...
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\php_framework\project\resources\views/creatures/index.blade.php ENDPATH**/ ?>