    ...
    <main>
        ...
        <div id="wrapper">
            ...
            <div id="contact_wrapper">
                ...
                <!-- Start of: form tag -->
                <form action="http://scott-media.com/test/form_display.php" method="post" id="signup_form" autocomplete="on" class="pt-10">
                    ...
                    <fieldset class="fieldset-padd">
                        ...
                        <p>
                            <input type="password" name="my_pw" id="my_pw" maxlength="16" minlength="8" placeholder="Please enter password *" required="required" />
                        </p>

                        <p>
                            <input type="password" name="re_pw" id="re_pw" maxlength="16" minlength="8" placeholder="Please re-enter password *" required="required" />
                        </p>
                ...
                <p>Already have an account? <a href="sign-up">Sign In</a></p>
            </div>
        </div>
        <!-- End of: wrapper  -->
...
</html><?php /**PATH C:\xampp\htdocs\php_framework\lab1\resources\views/register.blade.php ENDPATH**/ ?>